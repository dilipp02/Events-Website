<%-- 
    Document   : cultural1
    Created on : Oct 6, 2018, 7:43:16 PM
    Author     : dilip
--%>
...
<html>
    ...
    <body>
        ...
        <div id="navbar">
          ...
          %>
          <a href="new.jsp">News</a>
          <a href="gallery.jsp">Gallery</a>
        </div>
        <div class="content">
            <img src="photos/cultural1.jpg" alt="cultural" style="width:100%;">
            ...
            <form action="eventController">
                <button type="submit" class="registerbtn" value="cultural" name="cultural">Show All CULTURAL EVENTS</button>
            </form>
        </div>
        <script>
