...
public class eventController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(social!=null)
        {
            ses.setAttribute("eventCategory", social);
        }
        else if(cultural!=null)
        {
            ses.setAttribute("eventCategory", cultural);
        }
        else if(technical!=null)
        {
            ses.setAttribute("eventCategory", technical);
        }
        else
        {
            ses.setAttribute("eventCategory", sports);
        }
        RequestDispatcher rd = request.getRequestDispatcher("enrollmentPage.jsp");
